...
# curl curl https://raw.githubusercontent.com/eightdot2/dotfiles/master/.macos | bash

HOSTNAME="Copernicus"
TIMEZONE="Europe/London" # 'systemsetup -listtimezones'
...
# Four-letter codes for the other view modes: `icnv`, `clmv`, `Flwv`, `Nlsv` (icon, column, coverflow, list)
...
# Create my own brew tap instead of listing all the apps to install in the script?
